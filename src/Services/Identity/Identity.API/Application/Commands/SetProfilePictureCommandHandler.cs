...
public class SetProfilePictureCommandHandler : IRequestHandler<SetProfilePictureCommand>
{
    ...
    public async Task<Unit> Handle(SetProfilePictureCommand request, CancellationToken cancellationToken)
    {
