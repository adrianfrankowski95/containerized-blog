...
public class CreateAndSubmitRestaurantReviewPostCommandHandler : IRequestHandler<CreateAndSubmitRestaurantReviewPostCommand, ICommandResult>
{
    private readonly IPostRepository _postRepository;
    private readonly IIdentityService _identityService;
    private readonly ITagRepository _tagRepository;

    public CreateAndSubmitRestaurantReviewPostCommandHandler(
    ...
    public async Task<ICommandResult> Handle(CreateAndSubmitRestaurantReviewPostCommand request, CancellationToken cancellationToken)
    {
