...
public class CreateAndSubmitRestaurantReviewPostCommandHandler : IRequestHandler<CreateAndSubmitRestaurantReviewPostCommand, Unit>
{
    ...
    public async Task<Unit> Handle(CreateAndSubmitRestaurantReviewPostCommand request, CancellationToken cancellationToken)
    {
