...
public class UpdateRestaurantReviewPostDraftCommandHandler : IRequestHandler<UpdateRestaurantReviewPostDraftCommand, ICommandResult>
{
    private readonly IPostRepository _postRepository;
    private readonly IIdentityService _identityService;
    private readonly ITagRepository _tagRepository;

    public UpdateRestaurantReviewPostDraftCommandHandler(
    ...
    public async Task<ICommandResult> Handle(UpdateRestaurantReviewPostDraftCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            restaurantReviewPost.ToDraftBy(user);
        }
        catch (Exception ex)
        {
