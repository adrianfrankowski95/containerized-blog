...
public class UpdateRestaurantReviewPostDraftCommandHandler : IRequestHandler<UpdateRestaurantReviewPostDraftCommand, Unit>
{
    ...
    public async Task<Unit> Handle(UpdateRestaurantReviewPostDraftCommand request, CancellationToken cancellationToken)
    {
