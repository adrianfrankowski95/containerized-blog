...
public class CreateProductReviewPostDraftCommandHandler : IRequestHandler<CreateProductReviewPostDraftCommand, Unit>
{
    ...
    public async Task<Unit> Handle(CreateProductReviewPostDraftCommand request, CancellationToken cancellationToken)
    {
