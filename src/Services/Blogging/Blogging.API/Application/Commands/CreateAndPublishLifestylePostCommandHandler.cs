...
public class CreateAndPublishLifestylePostCommandHandler : IRequestHandler<CreateAndPublishLifestylePostCommand, ICommandResult>
{
    ...
    public async Task<ICommandResult> Handle(CreateAndPublishLifestylePostCommand request, CancellationToken cancellationToken)
    {
