...
public class UpdateLifestylePostDraftCommandHandler : IRequestHandler<UpdateLifestylePostDraftCommand, Unit>
{
    ...
    public async Task<Unit> Handle(UpdateLifestylePostDraftCommand request, CancellationToken cancellationToken)
    {
