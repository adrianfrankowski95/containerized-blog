...
public class UpdateLifestylePostDraftCommandHandler : IRequestHandler<UpdateLifestylePostDraftCommand, ICommandResult>
{
    private readonly IPostRepository _postRepository;
    private readonly IIdentityService _identityService;
    private readonly ITagRepository _tagRepository;

    public UpdateLifestylePostDraftCommandHandler(
    ...
    public async Task<ICommandResult> Handle(UpdateLifestylePostDraftCommand request, CancellationToken cancellationToken)
    {
