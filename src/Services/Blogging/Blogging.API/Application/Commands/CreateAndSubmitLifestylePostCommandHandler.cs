...
public class CreateAndSubmitLifestylePostCommandHandler : IRequestHandler<CreateAndSubmitLifestylePostCommand, Unit>
{
    ...
    public async Task<Unit> Handle(CreateAndSubmitLifestylePostCommand request, CancellationToken cancellationToken)
    {
