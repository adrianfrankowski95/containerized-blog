...
public class SubmitPostCommandHandler : IRequestHandler<SubmitPostCommand, ICommandResult>
{
    ...
    public async Task<ICommandResult> Handle(SubmitPostCommand request, CancellationToken cancellationToken)
    {
