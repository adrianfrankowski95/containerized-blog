...
public class CreateAndSubmitRecipePostCommandHandler : IRequestHandler<CreateAndSubmitRecipePostCommand, Unit>
{
    ...
    public async Task<Unit> Handle(CreateAndSubmitRecipePostCommand request, CancellationToken cancellationToken)
    {
