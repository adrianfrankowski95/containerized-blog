...
public class UpdateAndSubmitLifestylePostCommandHandler : IRequestHandler<UpdateAndSubmitLifestylePostCommand, Unit>
{
    ...
    public async Task<Unit> Handle(UpdateAndSubmitLifestylePostCommand request, CancellationToken cancellationToken)
    {
