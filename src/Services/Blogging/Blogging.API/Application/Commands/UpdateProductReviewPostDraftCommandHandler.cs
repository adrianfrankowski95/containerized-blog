...
public class UpdateProductReviewPostDraftCommandHandler : IRequestHandler<UpdateProductReviewPostDraftCommand, ICommandResult>
{
    private readonly IPostRepository _postRepository;
    private readonly IIdentityService _identityService;
    private readonly ITagRepository _tagRepository;

    public UpdateProductReviewPostDraftCommandHandler(
    ...
    public async Task<ICommandResult> Handle(UpdateProductReviewPostDraftCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            productReviewPost.ToDraftBy(user);
        }
        catch (Exception ex)
        {
