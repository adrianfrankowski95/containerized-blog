...
public class UpdateProductReviewPostDraftCommandHandler : IRequestHandler<UpdateProductReviewPostDraftCommand, Unit>
{
    ...
    public async Task<Unit> Handle(UpdateProductReviewPostDraftCommand request, CancellationToken cancellationToken)
    {
