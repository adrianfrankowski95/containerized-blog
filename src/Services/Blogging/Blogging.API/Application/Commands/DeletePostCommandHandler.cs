...
public class DeletePostCommandHandler : IRequestHandler<DeletePostCommand, ICommandResult>
{
    ...
    public async Task<ICommandResult> Handle(DeletePostCommand request, CancellationToken cancellationToken)
    {
