...
public class UpdateAndSubmitRecipePostCommandHandler : IRequestHandler<UpdateAndSubmitRecipePostCommand, Unit>
{
    ...
    public async Task<Unit> Handle(UpdateAndSubmitRecipePostCommand request, CancellationToken cancellationToken)
    {
