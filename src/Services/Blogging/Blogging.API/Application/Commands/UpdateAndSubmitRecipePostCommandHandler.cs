...
public class UpdateAndSubmitRecipePostCommandHandler : IRequestHandler<UpdateAndSubmitRecipePostCommand, ICommandResult>
{
    private readonly IPostRepository _postRepository;
    private readonly IIdentityService _identityService;
    private readonly ITagRepository _tagRepository;

    public UpdateAndSubmitRecipePostCommandHandler(
    ...
    public async Task<ICommandResult> Handle(UpdateAndSubmitRecipePostCommand request, CancellationToken cancellationToken)
    {
