...
public class UpdateAndPublishRecipePostCommandHandler : IRequestHandler<UpdateAndPublishRecipePostCommand, Unit>
{
    ...
    public async Task<Unit> Handle(UpdateAndPublishRecipePostCommand request, CancellationToken cancellationToken)
    {
