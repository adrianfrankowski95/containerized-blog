...
public class CreateAndSubmitProductReviewPostCommandHandler : IRequestHandler<CreateAndSubmitProductReviewPostCommand, ICommandResult>
{
    private readonly IPostRepository _postRepository;
    private readonly IIdentityService _identityService;
    private readonly ITagRepository _tagRepository;

    public CreateAndSubmitProductReviewPostCommandHandler(
    ...
    public async Task<ICommandResult> Handle(CreateAndSubmitProductReviewPostCommand request, CancellationToken cancellationToken)
    {
