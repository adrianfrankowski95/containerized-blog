...
public class CreateAndSubmitProductReviewPostCommandHandler : IRequestHandler<CreateAndSubmitProductReviewPostCommand, Unit>
{
    ...
    public async Task<Unit> Handle(CreateAndSubmitProductReviewPostCommand request, CancellationToken cancellationToken)
    {
